...
if ($(".imaCell").length !=0) {var color1=colorSele;var color2=colorBack;
$(".imaCell").css("background","-webkit-gradient(linear, left top, left bottom, from("+color1+"), to("+color2+"))");
$(".imaCell").css("background","-webkit-linear-gradient("+color1+", "+color2+")");
$(".imaCell").css("background","-moz-linear-gradient(top, "+color1+", "+color2+")");
$(".imaCell").css("background","-ms-linear-gradient("+color1+", "+color2+")");
$(".imaCell").css("background","-o-linear-gradient("+color1+", "+color2+")");
$(".imaCell").css("background","linear-gradient("+color1+", "+color2+")");
$(".imaCell").css("filter","progid:DXImageTransform.Microsoft.Alpha(startColorstr='"+color1+"', endColorstr='"+color2+"')");}
